...
Design Decisions
    ...
    Volatile Memory - Tasks are stored in RAM. This means the app is very fast and doesn't 
    need "save file" permissions, but data resets when the program is closed.
